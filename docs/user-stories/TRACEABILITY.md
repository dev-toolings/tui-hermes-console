...
| US-G1-SSH-001..010 | §9.4, §10 — recette SSH et stockage Docker détaillés | US-G1-008 | [états détaillés](SSH-STORIES.md), [garde SFTP locale 006A](evidence/2026-08-01-gate-1-ssh-sftp-006a-local.md), [migration Docker P-OPS 2026-08-02](evidence/2026-08-02-gate-1-ssh-storage-migration.md) | voir chaque story ; SSH-010 vérifiée sur VPS réel, acceptation reviewer et dépendances ouvertes |
