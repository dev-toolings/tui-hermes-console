    ...
    FROM (
      SELECT t.id AS resource_id,
        greatest(
          ...
          coalesce((SELECT max(r.created_at) FROM runs r WHERE r.site_id = t.site_id AND r.thread_id = t.id), t.updated_at),
      ...
      WHERE t.site_id = ${siteId}
        ...
        AND NOT EXISTS (
          ...
          WHERE r.site_id = t.site_id AND r.thread_id = t.id
